...
let udiv_bound (a : bound) (b : bound) : bound =
  ...
  | Int64 x, Int64 y -> Int64 (Int64.( / ) x y)
  | Int64 x, EInt y -> EInt (EInt.cstyle_div (EInt.of_int64 x) y)
  | Int64 x, BInt y -> BInt (BInt.cstyle_div (BInt.of_int64 x) y)
  | EInt x, Int64 y -> EInt (EInt.cstyle_div x (EInt.of_int64 y))
  | EInt x, EInt y -> EInt (EInt.cstyle_div x y)
  | EInt x, BInt y -> EInt (EInt.cstyle_div x (EInt.of_bint y))
  | BInt x, Int64 y -> BInt (BInt.cstyle_div x (BInt.of_int64 y))
  | BInt x, EInt y -> EInt (EInt.cstyle_div (EInt.of_bint x) y)
  | BInt x, BInt y -> BInt (BInt.cstyle_div x y)
;;
