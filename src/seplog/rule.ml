    ...
    | enc :: nencs ->
      let lhs, changed =
        ...
        | Pure (Reln ((RName rn, _) as rf)) ->
          ...
          | f -> errorh "rule_unfold_head: not pure reln body" pr_f f)
...
let compare_rule_unfold_head_vs_others pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule_unfold_head_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_unfold_view_left_vs_others pstate goal r1 r2 =
  ...
  | _ ->
    errorh "compare_rule_unfold_view_left_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_unfold_view_right_vs_others pstate goal r1 r2 =
  ...
  | _ ->
    errorh "compare_rule_unfold_view_right_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_match_data_vs_others pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule_match_data_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_match_view_vs_others pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule_match_view_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_match_array_vs_others pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule_match_array_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_subtract_data_vs_others pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule_subtract_data_vs_others: not expect" pr_rule r2
;;
...
let compare_rule_empty_array_right_vs_others pstate goal r1 r2 =
  ...
  | _ ->
    errorh "compare_rule_empty_array_right_vs_others: not expect" pr_rule r2
;;
...
let compare_transformation_rules pstate goal r1 r2 =
  ...
  | _ -> errorh "compare_rule: not expect" pr_rule r1
;;
